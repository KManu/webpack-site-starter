...
This is a simple HTML, SASS, JS starter template for simple websites. It's originally from Joel Hernandez's [webpack-starter-basic](https://github.com/lifenautjoe/webpack-starter-basic), but with a few modifications that are more suited to my personal development tastes. As such, visit his repository for more info on this template. Feel free to use as you wish. 
...
```sh
 git clone https://github.com/KManu/webpack-site-starter.git PROJECT-NAME
 cd PROJECT-NAME
```
